 ...
 * {@link StubBadConnectionSmartsheetService}. Whereas
 * {@link StubBadConnectionSmartsheetService} simulates random network errors,
 * {@link StubSpecificRequestFailureSmartsheetService} lets the tester control
 * which requests fail due to simulated network error. Tests can thus be
 * performed deterministically using this stub.
 */
public class StubSpecificRequestFailureSmartsheetService extends StubBadConnectionSmartsheetService {
	...
	public StubSpecificRequestFailureSmartsheetService() {
		simulateRandomConnectionErrors = false; // override random behaviour of
												// superclass
	}
