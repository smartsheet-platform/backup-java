...
public class SmartsheetUser extends SmartsheetNamedEntity {
    ...
    public String toString() {
        return "SmartsheetUser [name=" + name + ", id=" + id + ", email=" + email + ", admin=" + admin
                + ", licensedSheetCreator=" + licensedSheetCreator + ", status=" + status + "]";
    }
}
